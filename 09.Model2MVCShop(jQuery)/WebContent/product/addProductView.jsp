...
function fncAddProduct(){
	//Form 유효성 검증
 	var name = $($('.ct_input_g')[0]).val();
	var detail = $($('.ct_input_g')[1]).val();
	var manuDate = $($('.ct_input_g')[2]).val();
	var price = $($('.ct_input_g')[3]).val();
...
$(function(){
	...
	$( ".ct_btn01:contains('등록')" ).on("click" , function() {
		...
		//alert(  $( ".Depth03:contains('회원정보조회')" ) );
 		javascript:fncAddProduct();
	}); 
	$( ".ct_btn01:contains('취소')" ).on("click" , function() {
		//Debug..
		//alert(  $( ".Depth03:contains('회원정보조회')" ) );
 		javascript:resetData();
	}); 
