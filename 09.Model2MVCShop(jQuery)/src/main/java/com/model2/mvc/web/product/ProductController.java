...
public class ProductController {
	...
	public	ModelAndView addProduct(@ModelAttribute("product")Product product,@RequestParam("file")List<MultipartFile> multipartFiles) throws Exception {
		...
		for(MultipartFile multipartFile : multipartFiles) {
			...
			if(product.getFileName() != null) {
				product.setFileName(product.getFileName()+","+multipartFile.getOriginalFilename());
			}else {
	...
	public ModelAndView getProduct(HttpServletRequest request,HttpServletResponse response) throws  Exception {
		...
		String[] picArray = product.getFileName().split(",");
